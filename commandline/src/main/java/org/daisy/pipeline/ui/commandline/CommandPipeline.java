...
public class CommandPipeline extends Command {
	...
	public void execute() throws IllegalArgumentException {
		...
		XProcessorFactory fact = ((ServiceProvider)mArgs.get(PROVIDER)).getXProcessorFactory();
		XProcessor xproc = fact
				.getProcessor(getSaxSource(mArgs.getProperty(PIPELINE)));
		//bind inputs
