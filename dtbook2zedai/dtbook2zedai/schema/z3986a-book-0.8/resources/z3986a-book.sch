...
<schema xmlns:sch="http://purl.oclc.org/dsdl/schematron"
        ...
        queryBinding="xslt2"><!--generated: 2011-01-03T16:18:44.942-05:00--><!--input file: file:/D:/DAISY/zednext/temp/all-src-rng-preprocessed/z3986a-book.rng--><title>ISO Schematron tests for Book Profile version 0.8</title>
   ...
   <xsl:key xmlns:xsl="http://www.w3.org/1999/XSL/Transform" name="rdfprofile"
            match="default:document"
            use="document(@profile)//*[@property='rdfa:prefix']/text()"/>
   ...
   <ns uri="http://www.daisy.org/ns/z3986/annotations/#" prefix="z"/>
   ...
   <pattern>
      ...
      <sch:rule context="default:head[parent::default:document]">
         ...
         <sch:assert test="descendant::default:meta[@property='dcterms:date']">The head element must include a meta element indicating the document creation date (dcterms:date).</sch:assert>
      </sch:rule>
