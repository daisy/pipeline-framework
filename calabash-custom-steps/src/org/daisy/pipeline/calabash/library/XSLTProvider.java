...
package org.daisy.pipeline.calabash.library;
...
public class XSLTProvider implements XProcStepProvider {
	Logger logger = LoggerFactory.getLogger(this.getClass());
	public XProcStep newStep(XProcRuntime runtime, XAtomicStep step) {
		logger.info("creating xslt provider");
		return new XSLT(runtime, step);
	}
}
...
class XSLT extends DefaultStep {
    ...
    class CatchMessages implements MessageListener {
        ...
        public void message(XdmNode content, boolean terminate, javax.xml.transform.SourceLocator locator) {
            ...
            step.info(content,"Message:"+ content.toString());
