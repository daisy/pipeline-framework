...
public class ResultSetFactoryTest {
        ...
        public void getSize() throws Exception{
                ...
                try{
                        ...
                        //write 1024 bytes
                        //get size == 1024
                        JobResult res = ResultSetFactory.singleResult(tmp.toURI(),new URIMapper(URI.create(""),URI.create("")),"");
        ...
        public void getSizeNonExistingFile() throws Exception{
                        ...
                        JobResult res = ResultSetFactory.singleResult(fake.toURI(),new URIMapper(URI.create(""),URI.create("")),"");
                        res.getSize();
        }
}
